...
module.exports = function(options) {
  inquirer.prompt([{
    ...
    .then((answers) => {
      ...
      // which won't work when we run migrations. Relations require that they
      // be created in the database in the proper order.
      const resources = loadResourceModels(resourcesDir);

      // Sort them based on their dependencies, and then get our migration order.
